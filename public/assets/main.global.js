(() => {
  ...
  // node_modules/.pnpm/@hotwired+stimulus@3.0.1/node_modules/@hotwired/stimulus/dist/stimulus.umd.js
  var require_stimulus_umd = __commonJS({
    "node_modules/.pnpm/@hotwired+stimulus@3.0.1/node_modules/@hotwired/stimulus/dist/stimulus.umd.js"(exports, module) {
      (function(global, factory) {
        ...
        class Application2 {
          ...
          static start(element, schema) {
            const application = new Application2(element, schema);
            application.start();
            return application;
          }
          start() {
...
%o`, message, error2, detail);
        ...
        Controller2.targets = [];
        Controller2.values = {};
        exports2.Application = Application2;
        exports2.AttributeObserver = AttributeObserver;
        exports2.Context = Context;
        exports2.Controller = Controller2;
        exports2.ElementObserver = ElementObserver;
        exports2.IndexedMultimap = IndexedMultimap;
        exports2.Multimap = Multimap;
        exports2.StringMapObserver = StringMapObserver;
        exports2.TokenListObserver = TokenListObserver;
        exports2.ValueListObserver = ValueListObserver;
        exports2.add = add;
        exports2.defaultSchema = defaultSchema;
        exports2.del = del;
  ...
  // src/main.ts
  var import_stimulus2 = __toModule(require_stimulus_umd());

  // src/controllers/hello_controller.ts
  var import_stimulus = __toModule(require_stimulus_umd());
  var hello_controller_default = class extends import_stimulus.Controller {
    connect() {
  ...
  // src/main.ts
  var Stimulus = import_stimulus2.Application.start();
